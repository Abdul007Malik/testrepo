...
?>
<form action="index.php?option=com_helloworld&view=items" method="post" id="adminForm" name="adminForm">
	...
	<div class="row-fluid">
		<div class="span6">
			<div class="filter-select fltrt" style="float:right;">
				<?php echo JText::_('COM_HELLOWORLD_ITEMS_FILTER'); ?>
	...
	<table class="table table-striped table-hover">
		...
		<tr>
			...
			<th width="2%">
			    ...
			    <th width="25%">
                    <?php echo JHtml::_('grid.sort', 'COM_HELLOWORLD_ITEM_NAME', 'name', $listDirn, $listOrder); ?>
                </th>
				<th width="20%">
                    <?php echo JHtml::_('grid.sort', 'COM_HELLOWORLD_DESCRIPTION', 'description', $listDirn, $listOrder); ?>
                </th>
								<th width="10%">
		...
		<tbody>
			<?php if (!empty($this->items)) : ?>
				<?php foreach ($this->items as $i => $row) :
					$link = JRoute::_('index.php?option=com_helloworld&view=items&task=edit&id=' . $row->id); ?>
					<tr>
						<td>
						...
						<td>
							<a href="<?php echo $link; ?>" title="<?php echo JText::_('COM_HELLOWORLD_EDIT_ITEM'); ?>">
							<?php echo $row->name; ?></a>
							<div class="small">
									<?php echo JText::_('COM_HELLOWORLD_CATEGORY') . ': ' . $this->escape($row->category_title); ?>
							</div>
						</td>
						<td align="center">
