   ...
   protected $item;
    ...
    $layout = JRequest::getWord('layout', 'default');
        if($layout=='form'){
            ...
            $this->item			= $this->get('Item','category');
        ...
        // Set the submenu
		HelloWorldHelper::addSubmenu('categories');
	...
	protected function addToolBar($layout = "default")
    {
        if($layout=='form'){
            ...
            JToolBarHelper::title($title, 'CATEGORIES');
            if ($this->canDo->get('core.create'))
            {
	...
	protected function setDocument($layout='default')
	{
        if($layout=='form'){
            ...
            $document->setTitle($isNew ? JText::_('COM_HELLOWORLD_CATEGORIES_CREATING') :
                                JText::_('COM_HELLOWORLD_CATEGORIES_EDITING'));
			//$this->script=$this->get('Script','categories');
            //$document->addScript(JURI::root() . $this->script);
            $document->addScript(JURI::root() . "/administrator/components/com_helloworld"
                                 . "/views/categories/submitbutton.js");
            JText::script('COM_HELLOWORLD_CATEGORIES_ERROR_UNACCEPTABLE');
